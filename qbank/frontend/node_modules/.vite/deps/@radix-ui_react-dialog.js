...
function createSlottable(ownerName) {
  const Slottable2 = __name7((props) => "child" in props ? props.children(props.child) : props.children, "Slottable");
...
var getSlottableElementFromSlottable = __name7((slottable, child) => {
...
var createSlotError = __name7((ownerName) => {
  return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
}, "createSlotError");
var createSlottableError = __name7((ownerName) => {
...
var DismissableLayer = React10.forwardRef(
  ...
  __name10(function DismissableLayer2(props, forwardedRef) {
    const {
    ...
    React10.useEffect(() => {
      const handleUpdate = __name10(() => force({}), "handleUpdate");
...
var DismissableLayerBranch = React10.forwardRef(__name10(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React10.useContext(DismissableLayerContext);
...
var IS_TRUE = __name10(() => true, "IS_TRUE");
function usePointerDownOutside(onPointerDownOutside, args) {
  ...
  React10.useEffect(() => {
    ...
    const handlePointerDown = __name10((event) => {
  ...
  return {
    ...
    onPointerDownCapture: __name10(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture")
  };
}
...
function useFocusOutside(onFocusOutside, ownerDocument = globalThis == null ? void 0 : globalThis.document) {
  ...
  React10.useEffect(() => {
    const handleFocus = __name10((event) => {
  ...
  return {
    onFocusCapture: __name10(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
    onBlurCapture: __name10(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
  };
}
...
var Dialog = __name15((props) => {
  ...
  const [titleCount, setTitleCount] = React26.useState(0);
  const [descriptionCount, setDescriptionCount] = React26.useState(0);
...
var DialogTrigger = React26.forwardRef(
  __name15(function DialogTrigger2(props, forwardedRef) {
...
var DialogPortal = __name15((props) => {
...
var DialogOverlay = React26.forwardRef(
  __name15(function DialogOverlay2(props, forwardedRef) {
...
var DialogOverlayImpl = React26.forwardRef(
  // blank line to reduce diff noise
  __name15(function DialogOverlayImpl2(props, forwardedRef) {
...
var DialogContent = React26.forwardRef(
  __name15(function DialogContent2(props, forwardedRef) {
...
var DialogContentModal = React26.forwardRef(
  // blank line to reduce diff noise
  __name15(function DialogContentModal2(props, forwardedRef) {
    const context = useDialogContext(CONTENT_NAME, props.__scopeDialog);
    const contentRef = React26.useRef(null);
...
var DialogContentNonModal = React26.forwardRef(
  // blank line to reduce diff noise
  __name15(function DialogContentNonModal2(props, forwardedRef) {
    const context = useDialogContext(CONTENT_NAME, props.__scopeDialog);
...
var DialogContentImpl = React26.forwardRef(
  // blank line to reduce diff noise
  __name15(function DialogContentImpl2(props, forwardedRef) {
...
var DialogTitle = React26.forwardRef(
  __name15(function DialogTitle2(props, forwardedRef) {
...
var DialogDescription = React26.forwardRef(
  // blank line to reduce diff noise
  __name15(function DialogDescription2(props, forwardedRef) {
...
var DialogClose = React26.forwardRef(
  __name15(function DialogClose2(props, forwardedRef) {
...
var WarningProvider = __name15((props) => {
  return props.children;
}, "WarningProvider");
